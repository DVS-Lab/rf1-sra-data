...
bids_dir = "/data/projects/rf1-sra-data/bids" # edit if necessary
...
# Load in newsubs.txt
all_subs=np.loadtxt('../../rf1-sra-sharedreward/code/newsubs.txt')
...
### Restrict subs to sharedreward task & sample specified in newsubs.txt
df_full=df_full[df_full['task'].str.contains('sharedreward')]
df_full=df_full[df_full['Sub'].isin(all_subs)]
